...
import { Dropdown, Button, Divider, Menu, Space, Tooltip } from "../../../src";
import { IconDown } from "@arco-iconbox/react-growingio";
import { DropdownPositionType } from "../../../src/_core/types";
  ...
  render: (args, { intl: { formatMessage } }) => {
    ...
    return (
      <Dropdown
        ...
        onVisibleChange={(v) => {
          if (refMenuItemClicked.current === null || refMenuItemClicked.current === "closed") {
            setVisible(v);
          }
