...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => (
  <svg width={128} height={128} fill="none" {...props}>
    ...
    <path
      ...
      mask="url(#popconfirm-a)"
    />
    <rect width={8} height={8} x={24} y={49} fill="#6AA1FF" rx={4} />
    <rect width={36} height={4} x={36} y={49} fill="#BEDAFF" rx={2} />
    <rect width={69} height={4} x={36} y={58} fill="#BEDAFF" rx={2} />
    <rect width={24} height={8} x={81} y={69} fill="#6AA1FF" rx={1} />
    <rect width={24} height={8} x={53} y={69} fill="#BEDAFF" rx={1} />
  </svg>
);
