...
import { Button, Image, Skeleton, Space, Tooltip } from "../../../src";
import { IconEye, IconDownload, IconInfoCircle } from "@arco-iconbox/react-growingio";
    ...
    return (
      <Space direction="vertical" size="large">
        ...
        <Space size={20} align="start">
          ...
          <DemoImage {...args} width={200} simple={true} footerPosition="outer" />
        </Space>
      </Space>
    );
  },
...
export const Error: Story = {
  render: (args) => (
    <Space size={20}>
      <Image {...args} width={400} height={300} src="some-error.png" alt="some-error" />
      <Image
        {...args}
        width={400}
        height={300}
  ...
  render: (args) => {
    ...
    return (
      <>
        ...
        <Image.Preview {...args} visible={visible} onVisibleChange={setVisible} />
      </>
    );
  },
};
  ...
  render: (args) => {
    ...
    return (
      <>
        ...
        <Image.PreviewGroup {...args} visible={visible} onVisibleChange={setVisible} />
      </>
    );
  },
};
