...
import { Button, Empty, EmptyProps } from "../../../src";
        ...
        description={
          <Space size="small" direction="vertical">
            ...
            <Space>
              ...
              <Button type="primary">{formatMessage({ defaultMessage: "主按钮" })}</Button>
            </Space>
          </Space>
        }
      />
      <Empty
        ...
        description={
          <Space size="small" direction="vertical">
            ...
            <Space>
              <Button size="mini">{formatMessage({ defaultMessage: "次按钮" })}</Button>
...
export const Styles: Story = {
  ...
  render: (args, { intl }) => {
    ...
    return <Table borderCell columns={columns} data={data} pagination={false} />;
  },
};
