...
import { InputTag, Message, Radio, Space, Tag, Typography } from "../../../src";
...
const meta: Meta<typeof InputTag> = {
  component: InputTag,
  title: "Components/Data Entry/InputTag",
};
  ...
  render: (args, { intl: { formatMessage } }) => (
    <Space size="large" direction="vertical">
      <Space>
        ...
        />
        <InputTag {...args} placeholder={formatMessage({ defaultMessage: "只读状态" })} readOnly />
      </Space>
      <Space>
        <InputTag {...args} placeholder={formatMessage({ defaultMessage: "禁用状态" })} disabled />
        <InputTag {...args} placeholder={formatMessage({ defaultMessage: "错误状态" })} error />
      </Space>
    </Space>
  ),
};
...
export const PrefixAndSuffix: Story = {
  ...
  render: (args) => (
    <Space size="large" direction="vertical">
      <Space>
        <InputTag {...args} addBefore="https://" placeholder="GrowingIO.Design" />
        <InputTag {...args} addAfter={<IconSearch />} placeholder="GrowingIO Design" />
      </Space>
      <Space>
        <InputTag
          {...args}
    ...
    return (
      <Space size="large" direction="vertical">
        <Radio.Group type="button" name="size" value={size} onChange={setSize}>
          <Radio value="mini">{formatMessage({ defaultMessage: "迷你" })}</Radio>
          <Radio value="small">{formatMessage({ defaultMessage: "小" })}</Radio>
          <Radio value="default">{formatMessage({ defaultMessage: "中" })}</Radio>
...
export const SaveOnBlur: Story = {
  ...
  render: (args, { intl: { formatMessage } }) => (
    <InputTag {...args} placeholder={formatMessage({ defaultMessage: "输入然后直接失焦" })} />
  ),
};
...
export const TokenSeparator: Story = {
  ...
  render: (args, { intl: { formatMessage } }) => (
    <Space direction="vertical">
      ...
      <InputTag {...args} placeholder={formatMessage({ defaultMessage: "粘贴文本到此处" })} />
    </Space>
  ),
};
